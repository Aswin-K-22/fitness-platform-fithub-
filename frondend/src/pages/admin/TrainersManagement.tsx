...
const TrainerManagement: React.FC = () => {
  ...
  useEffect(() => {
    ...
    fetchTrainers();
  }, [page, debouncedSearchQuery, statusFilter, specializationFilter]);
  ...
  <input
    ...
    className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition sm:text-sm"
  />
</div>
